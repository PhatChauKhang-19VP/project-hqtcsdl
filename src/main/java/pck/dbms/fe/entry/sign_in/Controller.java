package pck.dbms.fe.entry.sign_in;
...
public class Controller {
    ...
    public void onBtnSignInClick(ActionEvent ae) throws InterruptedException {
        ...
        if (ae.getSource() == btnSignIn) {
            ...
            if (usernameTextField.getText().isBlank() || userPassword.getText().isBlank()) {
                ...
                if (usernameTextField.getText().isBlank() && userPassword.getText().isBlank()) {
                    invalidDetails.setText("Tên tài khoảng và mật khẩu không được bỏ trống!");
                    ...
                    if (usernameTextField.getText().isBlank()) {
                        usernameTextField.setStyle(errorStyle);
                        invalidDetails.setText("Tên tài khoảng không được bỏ trống!");
                ...
                // If all login details are entered as required then display success message
                    ...
                    String signInRes = App.getInstance().handleSQLSignIn(usernameTextField.getText(), userPassword.getText());
    ...
    public String toString() {
        return "pck.dbms.fe.entry.sign_in.Controller";
    }
}
