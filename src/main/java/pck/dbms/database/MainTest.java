...
//        loginInfo.setUsername("phatnm.partner1");
...
////        }
//
//        LoginInfo lgCus1 = new LoginInfo(); lgCus1.setUsername("customer1");
//        Customer customer = new Customer(); customer.setLogin(lgCus1);
//        Cart cart = new Cart(); cart.customer = customer;
//
//        LoginInfo lgParFood = new LoginInfo(); lgParFood.setUsername("partner_food");
//        Partner parFood = new Partner(); parFood.setLogin(lgParFood);
